...
export const PAIRS = [
  ...
  ['AdPriceHeader / title', { story: 'ad-detail-adpriceheader--car', sel: 'h1', n: 0, props: ALL }, { sel: '[data-parity="ad-price-header"] .ad-price-header__title', n: 0 }],
  ['AdPriceHeader / meta', { story: 'ad-detail-adpriceheader--car', sel: '[class*="_meta_"]', n: 0, props: SIZED }, { sel: '[data-parity="ad-price-header"] .ad-price-header__meta', n: 0 }],
  ['AdSpecsStrip / strip', { story: 'ad-detail-adspecsstrip--car', sel: '[class*="_strip_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-specs-strip"]', n: 0 }],
  ['AdSpecsStrip / cell', { story: 'ad-detail-adspecsstrip--car', sel: '[class*="_cell_"]', n: 0, props: SIZED }, { sel: '[data-parity="ad-specs-strip"] .ad-specs-strip__cell', n: 0 }],
  ['AdSpecsStrip / value', { story: 'ad-detail-adspecsstrip--car', sel: '[class*="_value_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-specs-strip"] .ad-specs-strip__value', n: 0 }],
  ['AdDetailsTable / heading', { story: 'ad-detail-addetailstable--collapsed', sel: 'h3', n: 0, props: ALL }, { sel: '[data-parity="ad-details"] .ad-details__heading', n: 0 }],
  ['AdDetailsTable / key', { story: 'ad-detail-addetailstable--collapsed', sel: '[class*="_key_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-details"] .ad-details__key', n: 0 }],
  ['AdDetailsTable / value', { story: 'ad-detail-addetailstable--collapsed', sel: '[class*="_value_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-details"] .ad-details__value', n: 0 }],
  ['AdDetailsTable / more', { story: 'ad-detail-addetailstable--collapsed', sel: '[class*="_more_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-details"] .ad-details__more', n: 0 }],
  ['AdLocation / heading', { story: 'ad-detail-adlocation--default', sel: 'h3', n: 0, props: ALL }, { sel: '[data-parity="ad-location"] .ad-location__heading', n: 0 }],
  ['AdLocation / pin', { story: 'ad-detail-adlocation--default', sel: '[class*="_pin_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-location"] .ad-location__pin', n: 0 }],
  ['AdLocation / area', { story: 'ad-detail-adlocation--default', sel: '[class*="_area_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-location"] .ad-location__area', n: 0 }],
  ['AdLocation / city', { story: 'ad-detail-adlocation--default', sel: '[class*="_city_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-location"] .ad-location__city', n: 0 }],
  ['AdLocation / map', { story: 'ad-detail-adlocation--default', sel: '[class*="_map_"]', n: 0, props: SIZED }, { sel: '[data-parity="ad-location"] .ad-location__map', n: 0 }],
  ['AdLocation / see', { story: 'ad-detail-adlocation--default', sel: '[class*="_seeLocation_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-location"] .ad-location__see', n: 0 }],
  ['AdDescription / body', { story: 'ad-detail-addescription--car', sel: '[class*="_body_"]', n: 0, props: ALL }, { sel: '[data-parity="ad-description"] .ad-description__body', n: 0 }],
  ['CandidateCard / card', { story: 'agency-portal-candidatecard--default', sel: 'article', n: 0, props: ALL }, { sel: '[data-parity="candidate-card"]', n: 0 }],
  ['CandidateCard / name', { story: 'agency-portal-candidatecard--default', sel: '[class*="_name_"]', n: 0, props: ALL }, { sel: '[data-parity="candidate-card"] .candidate-card__name', n: 0 }],
  ['CandidateCard / new', { story: 'agency-portal-candidatecard--default', sel: '[class*="_new_"]', n: 0, props: SIZED }, { sel: '[data-parity="candidate-card"] .candidate-card__new', n: 0 }],
  ['CandidateCard / tag', { story: 'agency-portal-candidatecard--default', sel: '[class*="_tag_"]', n: 0, props: SIZED }, { sel: '[data-parity="candidate-card"] .candidate-card__tag', n: 0 }],
  ['JobCard / selected', { story: 'agency-portal-jobcard--selected', sel: 'button', n: 0, props: SIZED }, { sel: '[data-parity="job-card-selected"]', n: 0 }],
  ['JobCard / resting', { story: 'agency-portal-jobcard--resting', sel: 'button', n: 0, props: SIZED }, { sel: '[data-parity="job-card"]', n: 0 }],
  ['JobCard / state', { story: 'agency-portal-jobcard--resting', sel: '[class*="_state_"]', n: 0, props: SIZED }, { sel: '[data-parity="job-card"] .job-card__state', n: 0 }],
  ['JobCard / count', { story: 'agency-portal-jobcard--resting', sel: '[class*="_count_"]', n: 0, props: ALL }, { sel: '[data-parity="job-card"] .job-card__count', n: 0 }],
  ['VipLeadCard / card', { story: 'agency-portal-vipleadcard--default', sel: 'article', n: 0, props: ALL }, { sel: '[data-parity="vip-card"]', n: 0 }],
  ['VipLeadCard / title', { story: 'agency-portal-vipleadcard--default', sel: '[class*="_top_"]', n: 0, props: ALL }, { sel: '[data-parity="vip-card"] .vip-card__top', n: 0 }],
  ['VipLeadCard / spec', { story: 'agency-portal-vipleadcard--default', sel: '[class*="_spec_"]', n: 0, props: ALL }, { sel: '[data-parity="vip-card"] .vip-card__spec', n: 0 }],
  ['VipLeadCard / purchase', { story: 'agency-portal-vipleadcard--default', sel: '[class*="_purchase_"]', n: 0, props: SIZED }, { sel: '[data-parity="vip-card"] .vip-card__purchase', n: 0 }],
  ['SideMenu rail / nav', { story: 'agency-portal-portalsidemenu--collapsed', sel: 'nav', n: 0, props: SIZED_NO_W }, { sel: '[data-parity="side-menu-rail"]', n: 0 }],
  ['SideMenu rail / item', { story: 'agency-portal-portalsidemenu--collapsed', sel: 'a', n: 0, props: SIZED }, { sel: '[data-parity="side-menu-rail"] .side-menu__item', n: 0 }],
  ['SideMenu rail / active', { story: 'agency-portal-portalsidemenu--collapsed', sel: 'a', n: 1, props: SIZED }, { sel: '[data-parity="side-menu-rail"] .side-menu__item', n: 1 }],
  ['SideMenu drawer / nav', { story: 'agency-portal-portalsidemenu--expanded', sel: 'nav', n: 0, props: [...SIZED_NO_W, 'width'] }, { sel: '[data-parity="side-menu-drawer"]', n: 0 }],
  ['SideMenu drawer / title', { story: 'agency-portal-portalsidemenu--expanded', sel: '[class*="_title_"]', n: 0, props: ALL }, { sel: '[data-parity="side-menu-drawer"] .side-menu__title', n: 0 }],
  // Batch 3 — popup captures
  ['ActionsMenu ad / menu', { story: 'agency-portal-actionsmenu--ad-card', sel: '[role="menu"]', n: 0, props: SIZED_NO_W }, { sel: '[data-parity="actions-ad"]', n: 0 }],
  ['ActionsMenu ad / item', { story: 'agency-portal-actionsmenu--ad-card', sel: '[role="menuitem"]', n: 0, props: SIZED }, { sel: '[data-parity="actions-ad"] .actions-menu__item', n: 0 }],
  ['ActionsMenu agent / menu', { story: 'agency-portal-actionsmenu--agent-row', sel: '[role="menu"]', n: 0, props: SIZED_NO_W }, { sel: '[data-parity="actions-agent"]', n: 0 }],
  ['ActionsMenu agent / item', { story: 'agency-portal-actionsmenu--agent-row', sel: '[role="menuitem"]', n: 0, props: SIZED }, { sel: '[data-parity="actions-agent"] .actions-menu__item', n: 0 }],
  ['CreditsSummary / panel', { story: 'agency-portal-creditssummary--default', sel: '[class*="_panel_"]', n: 0, props: SIZED_NO_W }, { sel: '[data-parity="credits-summary"]', n: 0 }],
  ['CreditsSummary / value', { story: 'agency-portal-creditssummary--default', sel: '[class*="_value_"]', n: 0, props: ALL }, { sel: '[data-parity="credits-summary"] .credits-summary__value', n: 0 }],
  ['CreditsSummary / legend', { story: 'agency-portal-creditssummary--default', sel: '[class*="_legend_"]', n: 0, props: ALL }, { sel: '[data-parity="credits-summary"] .credits-summary__legend', n: 0 }],
  ['MoreFilters / panel', { story: 'agency-portal-morefilterspanel--default', sel: '[class*="_panel_"]', n: 0, props: SIZED }, { sel: '[data-parity="more-filters"]', n: 0 }],
  ['MoreFilters / box', { story: 'agency-portal-morefilterspanel--default', sel: '[class*="_box_"]', n: 0, props: SIZED }, { sel: '[data-parity="more-filters"] .more-filters__box', n: 0 }],
  ['MoreFilters / apply', { story: 'agency-portal-morefilterspanel--default', sel: '[class*="_apply_"]', n: 0, props: SIZED }, { sel: '[data-parity="more-filters"] .more-filters__apply', n: 0 }],
  ['PortalModal md / panel', { story: 'agency-portal-portalmodal--export-leads', sel: '[role="dialog"]', n: 0, props: ALL }, { sel: '[data-parity="portal-modal-md"]', n: 0 }],
  ['PortalModal md / title', { story: 'agency-portal-portalmodal--export-leads', sel: '[class*="_title_"]', n: 0, props: ALL }, { sel: '[data-parity="portal-modal-md"] .portal-modal__title', n: 0 }],
  ['PortalModal / table key', { story: 'agency-portal-portalmodal--export-leads', sel: 'td', n: 0, props: ALL }, { sel: '[data-parity="portal-modal-md"] td', n: 0 }],
  ['PortalModal / table val', { story: 'agency-portal-portalmodal--export-leads', sel: 'td', n: 1, props: ALL }, { sel: '[data-parity="portal-modal-md"] td', n: 1 }],
  ['ReportAdDialog / title', { story: 'feedback-reportaddialog--default', sel: 'h2', n: 0, props: ALL }, { sel: '[data-parity="report-dialog"] .report-dialog__title', n: 0 }],
  ['ReportAdDialog / reason', { story: 'feedback-reportaddialog--default', sel: 'label', n: 0, props: SIZED }, { sel: '[data-parity="report-dialog"] .report-dialog__reason', n: 0 }],
  ['ReportAdDialog / ring', { story: 'feedback-reportaddialog--default', sel: '[class*="_ring_"]', n: 0, props: SIZED }, { sel: '[data-parity="report-dialog"] .report-dialog__ring', n: 0 }],
  ['ReportAdDialog / comment', { story: 'feedback-reportaddialog--default', sel: 'textarea', n: 0, props: ALL }, { sel: '[data-parity="report-dialog"] textarea', n: 0 }],
  ['ReportAdDialog / send', { story: 'feedback-reportaddialog--default', sel: '[class*="_send_"]', n: 0, props: SIZED }, { sel: '[data-parity="report-dialog"] .report-dialog__send', n: 0 }],
  // Overlays & feedback
